  ...
  return (
    <div className="stage3-quiz-container">
      <div className="stage3-quiz-header">
        <h1 className="stage3-quiz-title">🅱️ Short Answer - Stage 12 (Bootstrap Final)</h1>
        ...
        <div style={{ background: '#fff3e0', padding: '8px 15px', borderRadius: '8px', marginTop: '10px', fontSize: '0.9em', color: '#e65100' }}>
          ⚠️ ต้องได้ {MIN_PASSING_SCORE}/100 คะแนนขึ้นไป (80%) จึงจะผ่านด่าน - 🏆 ด่านสุดท้าย!
        </div>
      ...
      <div className="stage3-quiz-content">
        {!gameCompleted ? (
          ...
          <div className="stage3-completion-message">
            {isPassed ? (
              <>
                <div style={{ color: '#4caf50', fontSize: '2.5em', marginBottom: '10px' }}>🎉🏆 ยินดีด้วย! จบเกมแล้ว! 🏆🎉</div>
                <div style={{ background: 'linear-gradient(135deg, #ffd700 0%, #ffb700 100%)', color: '#333', padding: '20px 30px', borderRadius: '15px', marginBottom: '25px', fontSize: '1.3em', fontWeight: 'bold' }}>
                  🌟 คุณผ่านทุกด่านครบแล้ว! ยอดเยี่ยมมาก! 🌟
                </div>
              </>
            ) : (
              <>
