...
const Stage6 = () => {
  ...
  const questions = [
    { question: "Property ใดใช้สำหรับกำหนดสีของตัวอักษร", correctAnswers: ["color", "COLOR", "Color"], hint: "คำภาษาอังกฤษที่แปลว่า 'สี'" },
    { question: "Property ใดใช้สำหรับกำหนดความกว้างของ element", correctAnswers: ["width", "WIDTH", "Width"], hint: "คำภาษาอังกฤษที่แปลว่า 'ความกว้าง'" },
    { question: "Property ใดใช้สำหรับกำหนดระยะห่างภายนอกของ element", correctAnswers: ["margin", "MARGIN", "Margin"], hint: "ระยะห่างระหว่าง element กับ element อื่น" },
    { question: "Property ใดใช้สำหรับกำหนดระยะห่างภายในของ element", correctAnswers: ["padding", "PADDING", "Padding"], hint: "ระยะห่างระหว่าง content กับขอบ element" },
    { question: "Property ใดใช้สำหรับกำหนดรูปแบบการแสดงผลของ element", correctAnswers: ["display", "DISPLAY", "Display"], hint: "เช่น block, inline, flex, grid" }
  ];
