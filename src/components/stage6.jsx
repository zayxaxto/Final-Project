...
const Stage6 = () => {
  ...
  const PREVIOUS_LEVEL = 5;
  const MIN_PASSING_SCORE = 80;
  const POINTS_PER_QUESTION = 20;

  // คำถาม CSS Short Answer (ใช้ข้อสอบชั่วคราว - เปลี่ยนทีหลังได้)
  const questions = [
    {
      question: "หน่วยวัดใดใน CSS เป็นหน่วยวัดแบบสัมพัทธ์ที่อ้างอิงจากฟอนต์ของ parent element",
      correctAnswers: ["em", "EM"],
      hint: "เป็นหน่วย Relative ที่ใช้บ่อยในการกำหนดขนาดตัวอักษร"
    },
    {
      question: "หน่วยวัดใดใน CSS เป็นหน่วยวัดแบบคงที่ (Absolute) ที่ใช้บ่อยที่สุด",
      correctAnswers: ["px", "PX"],
      hint: "ย่อมาจาก Pixel"
    },
    {
      question: "Property ใดใช้สำหรับกำหนดชนิดตัวอักษร",
      correctAnswers: ["font-family", "FONT-FAMILY", "Font-Family"],
      hint: "ใช้เลือกแบบอักษร เช่น Sarabun หรือ sans-serif"
    },
    {
      question: "Property ใดใช้สำหรับจัดตำแหน่งข้อความให้อยู่กึ่งกลาง",
      correctAnswers: ["text-align", "TEXT-ALIGN", "Text-Align"],
      hint: "ต้องกำหนดค่าเป็น center"
    },
    {
      question: "Property ใดใช้สำหรับกำหนดรูปภาพพื้นหลัง",
      correctAnswers: ["background-image", "BACKGROUND-IMAGE", "Background-Image"],
      hint: "ใช้ใส่ URL ของรูปภาพ"
    }
  ];
  ...
  return (
    <div className="stage3-quiz-container">
      <div className="stage3-quiz-header">
        <h1 className="stage3-quiz-title">🎨 Short Answer - Stage 6 (CSS Final)</h1>
